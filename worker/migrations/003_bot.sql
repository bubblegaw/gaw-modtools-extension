-- ============================================================================
-- GAW ModTools Worker — Migration 003: AI-Tools Bot (Grok + Llama, Discord)
-- ============================================================================
-- Apply with:
--   wrangler d1 execute AUDIT_DB --file=migrations/003_bot.sql
-- ============================================================================

-- Mod allowlist. Discord user IDs are snowflakes (big ints as strings).
...
-- Feature requests proposed via /propose.
...
-- Polls (1:1 with feature_requests while in the polling phase).
...
-- Individual votes. One row per (poll, voter).
...
-- Conversation memory: short rolling per-thread transcript so Grok can be
-- contextually aware of follow-up questions without needing massive context.
...
-- Audit of every AI call for cost/usage tracking + debugging.
